  ...
  return (
    ...
    <div className="bg-[#ffffff] text-[#000000] min-h-screen py-40 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <p className="text-[#6a5848] text-base sm:text-lg max-w-2xl mx-auto leading-relaxed italic">
      ...
      <div className="max-w-4xl mx-auto mb-24">
        <div className="relative overflow-hidden rounded-2xl border border-gray-800 bg-[#a79b81] p-4 shadow-2xl">
          ...
          <p className="text-center text-xs sm:text-sm text-[#000000] mt-4 italic">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-sm sm:text-base mb-24">
        ...
        <div className="md:col-span-2 space-y-6 text-[#000000]">
          ...
          <blockquote className="border-l-4 border-[#d9a05b] bg-[#917c4b] p-5 my-6 rounded-r-lg italic text-[#fafafa] font-serif">
      ...
      <div className="max-w-4xl mx-auto mb-24 relative border-t border-gray-800 pt-16">
        ...
        <div className="space-y-12">
          {/* Node 1 */}
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-12 bg-[#917c4b] p-6 rounded-xl border border-gray-800">
            ...
            <div>
              ...
              <p className="text-[#ffffff] text-sm leading-relaxed text-justify">
      ...
      <div className="max-w-3xl mx-auto text-center bg-gradient-to-b from-[#917c4b] to-transparent p-8 sm:p-12 rounded-2xl border border-gray-800/60">
        ...
        <p className="text-xs text-[#000000] tracking-wide uppercase">
