...
export default function Hero() {
  ...
  const slides = [
    {
      ...
      ctaSecondary: { text: "Lihat Katalog", href: "#produk" }, // Akan memicu scroll halus
  ...
  // Fungsi interseptor untuk menangani scroll halus pada anchor ID
  ...
  return (
    <section className="relative pt-32 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-12 min-h-[85vh] group">
      ...
      <div className="flex-1 space-y-6 text-center lg:text-left min-h-[380px] flex flex-col justify-center lg:items-start transition-all duration-500 pl-4 lg:pl-12">
        ...
        <div className="flex flex-col justify-center w-full gap-4 pt-2 sm:flex-row lg:justify-start sm:w-auto">
          <Link 
            ...
            className="px-6 py-3.5 bg-[#C59B5F] hover:bg-[#A67D45] text-[#F5F2EB] font-bold rounded-full text-sm tracking-wide shadow-md shadow-[#C59B5F]/10 transition-all duration-300 transform hover:-translate-y-0.5 text-center"
          >
          ...
          <Link 
            ...
            className="px-6 py-3.5 bg-transparent border border-[#6E655C]/30 text-[#2D2219] hover:border-[#2D2219] font-medium rounded-full text-sm tracking-wide transition-colors text-center"
          >
      ...
      <div className="flex justify-center flex-1 w-full max-w-lg pr-4 lg:max-w-none lg:justify-end lg:pr-12">
        <div className="relative w-full aspect-[4/5] max-h-[500px] bg-[#EFEBE3] border border-[#2D2219]/5 rounded-2xl overflow-hidden shadow-xl flex flex-col justify-between animate-fade-in">
          
          {/* Bagian Header Kecil Atas Mockup Browser */}
          <div className="flex justify-between items-center text-xs text-[#6E655C] border-b border-[#2D2219]/5 pb-3 pt-4 px-4 bg-[#EFEBE3] z-10">
            <span className="flex items-center gap-1.5">
              <span className="w-2 h-2 bg-red-400 rounded-full"></span>
              <span className="w-2 h-2 bg-yellow-400 rounded-full"></span>
              <span className="w-2 h-2 bg-green-400 rounded-full"></span>
            </span>
            <span className="font-mono text-[10px] opacity-70">LIVE VIDEO CONTENT</span>
          </div>
          ...
          <div className="bg-[#F5F2EB] border-t border-[#2D2219]/5 p-3 rounded-b-2xl space-y-2 z-10">
            <div className="flex justify-between text-[10px] text-[#6E655C]">
              <span>Katalog Tekstil Premium</span>
              <span className="text-[#C59B5F] font-medium">Atmanegara Lurik Heritage</span>
            </div>
