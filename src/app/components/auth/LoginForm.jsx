...
export default function LoginForm() {
  ...
  return (
    <div className="w-screen h-screen m-0 p-0 flex bg-[#F8F9FA] font-sans select-none items-stretch overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-[#27437c] to-[#F5F2EB]/80 p-16 flex-col justify-between relative overflow-hidden h-full">
        
        <div className="z-20 pt-6 space-y-10">
          <motion.div 
          ...
          >
            <h1 className="text-3xl font-bold leading-tight tracking-wide text-white">
              Kain Lurik Premium dengan <span className="text-[#F2B600] underline decoration-2 underline-offset-4">Kualitas Asli</span> & <span className="text-[#F2B600]">Desain Modern</span>
            </h1>
            <p className="text-sm leading-relaxed text-white/70">
              Jelajahi keindahan wastra tenun tangan ATBM premium. Temukan beragam motif autentik, kemudahan kustomisasi, dan pengalaman belanja budaya Nusantara yang tepercaya.
            </p>
          </motion.div>
        </div>
        ...
        {/* --- PERBAIKAN STRUKTUR ARRAY MAP SEBELUMNYA DI SINI --- */}
        <motion.div 
          initial="hidden"
          animate="visible"
          variants={{
