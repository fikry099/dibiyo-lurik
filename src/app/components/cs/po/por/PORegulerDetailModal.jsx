...
export default function PORegulerDetailModal({ isOpen, onClose, item }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#1A335A7A] font-inter animate-fade-in">
      {/* Box Modal */}
...
<div className="grid grid-cols-1 gap-4 md:grid-cols-5">
  ...
  <div className="md:col-span-3 bg-[#FFECA7] border border-[#FFEBAA] rounded-lg p-4 space-y-3">
    ...
    {/* Grid dengan pembatas atas, bawah, dan vertikal kanan */}
      ...
      <div className="pl-3">
                  ...
                  <div key={idx} className="flex flex-col justify-between gap-4 p-3  rounded-lg sm:flex-row sm:items-center bg-[#5AE3ED]/5 border border-gray-100">
                    ...
                    <div className="grid flex-1 grid-cols-2 gap-4 sm:grid-cols-4">
                      ...
                      <div>
                        ...
                        {/* PERUBAHAN: Diubah dari harga_per_meter menjadi mengambil dari field subtotal */}
        ...
        <div className="flex justify-end px-6 py-3 border-t border-gray-100 rounded-b-lg bg-gray-50">
          <button 
            ...
            className="flex items-center gap-2 bg-[#1A335A] hover:bg-[#11223d] text-white font-bold px-4 py-2 rounded-md text-[11px] shadow transition-colors"
          >
            <Printer size={13} />
            Cetak Struk
          </button>
