...
export default function POCustomTable({ data, onConfirmReceipt, onEdit, onDelete }) {
  ...
  return (
    <div className="w-full overflow-x-auto">
                  ...
                  {waFormatted ? (
                    ...
                    >
                      <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                        <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.513 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.503-5.713-1.458L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.37 9.864-9.799.002-2.63-1.023-5.101-2.885-6.963C16.428 1.98 13.96 .951 11.343.951c-5.44 0-9.866 4.372-9.87 9.8'c-.001 1.701.453 3.361 1.314 4.814L1.706 22.28l4.941-1.293z"/>
                      </svg>
      ...
      {/* RENDER MODAL DETAIL DI BAWAH TABEL */}
      <PODustomDetailModal 
        isOpen={isModalOpen}
