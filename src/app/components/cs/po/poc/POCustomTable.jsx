          ...
          <tr key={item.id} className="border-b border-[#D4A373]/20 hover:bg-amber-50/20 transition-colors">
            ...
            <td className="px-4 py-4">
              <div className="flex items-center justify-center gap-1.5">
                <button className="bg-[#8B5E3C] hover:bg-[#724c30] text-white text-[11px] px-2 py-1 rounded shadow-sm transition-colors font-medium">Produk di Terima</button>
                <button className="bg-[#4AD3B0] hover:bg-[#3bc2a0] text-white p-1 rounded shadow-sm"><Eye size={14} /></button>
                <button className="bg-[#F0A55D] hover:bg-[#e0944b] text-white p-1 rounded shadow-sm"><Edit size={14} /></button>
                <button className="bg-[#FF6B6B] hover:bg-[#f05656] text-white p-1 rounded shadow-sm"><Trash2 size={14} /></button>
              </div>
            </td>
          </tr>
        ))}
