      ...
      <div className="bg-white rounded-[20px] shadow-[2px_4px_4px_0px_rgba(0,0,0,0.25)] w-[372px] relative">
        ...
        <form onSubmit={handleSubmit} className="px-5 pt-4 pb-5">
          ...
          <input
            ...
            maxLength={100}
            autoFocus
            className="w-full h-[46px] px-3 rounded-[10px] border border-[#a47352] text-[#a47352] text-sm focus:outline-none focus:ring-1 focus:ring-[#a47352] transition-all disabled:opacity-60 uppercase"
