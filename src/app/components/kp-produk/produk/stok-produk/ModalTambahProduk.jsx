...
export default function ModalTambahProduk({
  ...
  // ── Form state utama (Tanpa rakId di tingkat Produk) ──
  ...
  // ── PRE-COMPUTE UNTUK MENGAMANKAN DEPENDENCY ARRAY EFFECT ──
  ...
  // ── LOGIKA AUTO-FILL HARGA UTAMANYA ──
  useEffect(() => {
  ...
  // ── 💡 LOGIKA RENDERING MODAL SUKSES (PERSIS SEPERTI DI GAMBAR MOCKUP image_633a66.png) ──
  if (showSuccess) {
    return createPortal(
      <div className="fixed inset-0 w-screen h-screen z-[9999] flex items-center justify-center bg-[#ae834e]/53 backdrop-blur-[2px] p-4 cursor-default animate-in fade-in duration-100">
        <div className="bg-white rounded-[24px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.15)] w-full max-w-[360px] py-10 px-6 flex flex-col items-center justify-center animate-in fade-in zoom-in-95 duration-150 border border-gray-50">
    ...
    <div className="fixed inset-0 w-screen h-screen z-[9998] flex items-center justify-center bg-[#ae834e]/53 backdrop-blur-[2px] p-4 cursor-default animate-in fade-in duration-100">
      ...
      <div className="relative bg-white shadow-2xl rounded-[24px] w-full max-w-[760px] max-h-[92vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-150 p-6 space-y-4">
        ...
        <div className="overflow-y-auto custom-scrollbar flex-1 pr-1 space-y-5 text-xs text-[#5C4033]">
          ...
          {/* Uploader Gambar Banner Melengkung */}
          ...
          <div className="space-y-4">
            ...
            {/* List Tampilan Gulungan Row Table Penampung */}
