...
export default function LaporanPoRegulerTable({ data, loading }) {
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b bg-stone-50 border-stone-200 text-stone-600">
              ...
              <th className="px-6 py-4 text-xs font-bold tracking-wider uppercase">ID PO</th>
            ...
            {loading ? (
              ...
              <tr>
                <td colSpan="7" className="px-6 py-12 font-medium text-center text-stone-400">
                  Tidak ada data Pre-Order Reguler pada periode atau filter ini.
                </td>
              </tr>
            ) : (
              // Tampilan Data Asli
              data.map((row, index) => {
                ...
                return (
                  <tr key={row.id} className="transition-colors hover:bg-stone-50/50">
                    ...
                    <td className="px-6 py-4 font-mono text-sm font-semibold text-stone-800">
