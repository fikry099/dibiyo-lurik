...
export default function LaporanPoRegulerTable({ data = [], loading }) {
  ...
  return (
    /* Trik Utama: -mx-6 membuat tabel melar penuh dari ujung kiri ke ujung kanan kontainer putih */
    <div className="w-auto mt-4 -mx-6 overflow-hidden bg-white">
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            {/* Menggunakan warna biru gelap navy solid */}
            <tr className="bg-[#1e355e] text-white text-[13px] font-medium tracking-wide">
              ...
              <th className="py-3.5 px-4">ID PO</th>
